...
//        Taxi myTaxi = new Taxi("1", 1, 5, true, 1);
//        //If it takes Vehicle's method it should return 5
//        //If it takes Car's method it should return 4
//        if (myTaxi.calculateTollPrice() == 4){
//            System.out.println("Takes the Car's method");
//        }
//        if (myTaxi.calculateTollPrice() == 5){
//            System.out.println("Takes the vehicle's method");
//        }
//
...
//        myTruck3.printInfo();
        ...
        myVehicle3.printDestinationStatement();
        myCar3.printDestinationStatement();
        myTruck3.printDestinationStatement();
        myTaxi4.printDestinationStatement();
